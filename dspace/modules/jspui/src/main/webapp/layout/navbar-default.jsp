         ...
         <ul id="top-menu" class="nav navbar-nav navbar-<%= isRtl ? "right":"left"%>">
		  ...
		  <% if(showCommList){ %>
		   <li id="communitylist-top-menu" class="<%= currentPage.endsWith("/community-list")? 
        		 ...
        		 <% }%>
            <li class="<%= currentPage.endsWith("/about/journals.jsp")?
        		   "active" : "" %>"><a href="<%= request.getContextPath() %>/about/journals.jsp"><fmt:message key="jsp.layout.navbar-default.journals"/></a></li>
