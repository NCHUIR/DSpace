    ...
    public void run() {
        ...
        */
        ...
        try {
            ...
            query.append("SELECT count(a) AS number_of_items, count(g) AS number_of_bs FROM item AS a LEFT JOIN ( SELECT b.item_id,MAX(b.bundle_id),MAX(c.primary_bitstream_id) FROM item2bundle AS b LEFT JOIN bundle AS c ON b.bundle_id = c.bundle_id WHERE c.name = '");
